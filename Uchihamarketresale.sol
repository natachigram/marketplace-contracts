...
function listSale(uint256 tokenId, uint256 price) public payable nonReentrant {
    require(nft.ownerOf(tokenId) == msg.sender, "This NFT doesn't belong to you");
...
function buyNFT(uint256 itemId) public payable nonReentrant {
    ...
    require(msg.value == price, "Pay total amount to complete transaction");
 ...
 //function to check the NFTs that we have available for purchase
 ...
 //IRC721 standard contract function to receive NFTs
